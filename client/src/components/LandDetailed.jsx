...
const LandDetailed = () => {
  return (
    <div className="w-full px-4 py-10 bg-[#f9f7f0] flex flex-col gap-6 max-w-7xl mx-auto">
      {/* Header Section */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-2">
        <div>
          <h1 className="text-xl md:text-2xl font-bold">Bannerghatta road, kalkere 1st..</h1>
          <p className="text-sm font-medium text-gray-700">Land/plots in bannerghatta road</p>
          <p className="text-xs text-gray-500">
            Description : Melodies of Life offers plots in Hosa Road , Bangalore South, for sale
          </p>
        </div>
      ...
      {/* Image Gallery and Form */}
      <div className="flex flex-col lg:flex-row gap-6">
        {/* Image Gallery */}
        <div className="flex-1">
          <div className="grid grid-cols-3 gap-2">
            <div className="col-span-3">
              <img src={mainImg} alt="main" className="w-full rounded-xl h-[250px] object-cover" />
            </div>
        ...
        {/* Contact Form */}
        <div className="w-full lg:w-[350px] border border-gray-300 rounded-xl p-4 shadow-md bg-white">
      ...
      <div className="grid md:grid-cols-2 gap-6 text-sm text-gray-700">
        <ul className="space-y-2">
          <li>📍 BJS Colony, Jodhpur — near School, Highway, Hospital, Metro</li>
